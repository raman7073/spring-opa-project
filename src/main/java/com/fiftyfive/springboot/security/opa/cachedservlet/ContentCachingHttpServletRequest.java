package com.fiftyfive.springboot.security.opa.cachedservlet;
...
/**
 * We will also need to pass the Application API Request Payload as part of the Input into OPA,
 * so we will create a HttpServletRequestWrapper that will be wrapped around the original
 * HttpServletRequest
 *
 */
